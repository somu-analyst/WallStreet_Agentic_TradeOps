...
## ⚡ Efficiency rules
- **Canonical files:** `telegram_bot_optimized.py` (~40k lines, THE running bot + engine) · `dashboard.py` (Streamlit, imports the bot at runtime). Edit directly — NEVER patch/helper scripts.
