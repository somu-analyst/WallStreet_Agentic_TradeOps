...
- [ ] **`/debate` weight rebalance.** Re-verified 2026-07-24: still genuinely open — `_AGENT_WEIGHTS = {"Flow": 1.2, "Position": 1.1, "Technical": 1.0, "Vol": 0.4, "Macro": 0.7}`, Flow untouched at the highest weight despite zero measured edge (t=−0.07); Technical has real edge (t=+4.28) at only 1.0. Rebalancing on one backtest risks overfitting. Awaiting user.
