...
(115,"2026-08-03","User","Bug","ADR tickers rejected as invalid on add (KSPI)",
 ...
 "QUEUED","","KSPI = Kaspi.kz, a NASDAQ-listed ADR. The add-validation path evidently rejects it. Needs checking whether the failure is validation, the quote lookup, or universe membership - and then whether ADRs flow through capture/scanners at all",
 "-","P1","Reproduce the add path for KSPI; widen validation to accept any quoted US-listed symbol"),
