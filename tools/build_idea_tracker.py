...
(116,"2026-08-03","User","Bug","GEX Co-Pilot shows only the checklist - no gamma wall charts",
 ...
 "QUEUED","","Confirmed by design, not a fault: the merged page splits into three sub-views via a SIDEBAR radio (GEX view), so Co-Pilot renders only the co-pilot and the charts live under GEX Profile / Gamma Wall Advisor. The radio is easy to miss",
 "-","P1","Put the wall chart on the Co-Pilot view itself, or surface the sub-view picker in the main pane instead of the sidebar"),
